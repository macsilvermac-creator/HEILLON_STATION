    ...
    <div className="relative flex min-h-screen items-center justify-center px-4 pt-24">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="login-email" className="mb-2 block text-sm text-white/60">Email</label>
            <input
              id="login-email"
              name="email"
              type="email"
          ...
          <div>
            <label htmlFor="login-password" className="mb-2 block text-sm text-white/60">Password</label>
            <input
              id="login-password"
              name="password"
              type="password"
