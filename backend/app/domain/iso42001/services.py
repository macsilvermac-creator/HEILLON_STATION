    ...
    def register(
        ...
        *,
        ...
        conformity_score = self._compute_score(
            ...
            c5_top_mgmt_commitment=c5_top_mgmt_commitment,
            c5_roles_defined=c5_roles_defined,
            c6_risks_assessed=c6_risks_assessed,
            c6_objectives_set=bool(c6_objectives_set),
        ...
        self._repo.create(
            ...
            c4_internal_issues=c4_internal_issues,
            c4_external_issues=c4_external_issues,
            c4_interested_parties=c4_interested_parties,
            c4_aims_scope=c4_aims_scope,
            c4_ai_policy_defined=c4_ai_policy_defined,
            c5_top_mgmt_commitment=c5_top_mgmt_commitment,
            c5_ai_policy_text=c5_ai_policy_text,
            c5_roles_defined=c5_roles_defined,
            c5_dpo_appointed=c5_dpo_appointed,
            c6_risks_assessed=c6_risks_assessed,
            c6_opportunities_noted=c6_opportunities_noted,
            c6_objectives_set=c6_objectives_set,
            c6_action_plans=c6_action_plans,
            c7_resources_allocated=c7_resources_allocated,
    ...
    def add_control_evidence(
        ...
        *,
        ...
        if control_ref not in ANNEX_A_CONTROLS:
            raise ValueError(
                f"control_ref must be one of {list(ANNEX_A_CONTROLS.keys())}"
            )
...
class FRIAService:
    ...
    def create(
        ...
        *,
        ...
        self._repo.create(
            ...
            right_dignity=right_dignity,
            right_privacy=right_privacy,
            right_nondiscrimination=right_nondiscrimination,
            right_fair_trial=right_fair_trial,
            right_presumption=right_presumption,
            right_labour=right_labour,
            right_education=right_education,
    ...
    def reject(
        ...
        self._repo.reject(
            conn, fria_id, rejected_by=rejected_by, rejection_reason=rejection_reason
        )
