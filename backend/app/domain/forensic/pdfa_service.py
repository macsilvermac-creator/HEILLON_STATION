...
class PDFA1bService:
    ...
    def _register_fonts(self) -> None:
        ...
        if os.path.isdir(dejavu) and all(os.path.isfile(p) for _, p in dj_paths):
            try:
                ...
                self.font_regular, self.font_bold, self.font_mono = (
                    dj_paths[0][0],
                    dj_paths[1][0],
                    dj_paths[2][0],
                )
    ...
    def generate_executive_report(
        ...
        *,
        ...
        generated_by = (manifest.generated_by if manifest is not None else "") or (
            generated_by_override or ""
        )
        ...
        story.append(
            Paragraph("Chain of Custody — Algorithmic Audit", styles["cover-subtitle"])
        )
        story.append(Spacer(1, 2 * cm))

        mission_info = [
            [
                Paragraph("<b>Mission ID:</b>", styles["label"]),
                Paragraph(mission_id, styles["value-mono"]),
            ],
            [
                Paragraph("<b>Generated by:</b>", styles["label"]),
                Paragraph(generated_by or "—", styles["value"]),
            ],
            [
            ...
            [
                Paragraph("<b>Total HDRs:</b>", styles["label"]),
                Paragraph(str(total_hdrs), styles["value"]),
            ],
            [
                Paragraph("<b>Package ID:</b>", styles["label"]),
                Paragraph(pkg_id, styles["value-mono"]),
            ],
        ]
        ...
        if len(ordered) > 12:
            story.append(
                Paragraph(
                    "<i>Further steps omitted for brevity — see JSON annex.</i>",
                    styles["body"],
                )
            )
            ...
            TableStyle(
                [
                    ...
                    (
                        ...
                        (0, 1),
                        (-1, -1),
                        [HexColor("#0A0F1E"), HexColor("#0F1A2E")],
                    ),
        ...
        integrity_info = [
            ...
            [
                Paragraph("<b>Chain root:</b>", styles["label"]),
                Paragraph(root or "—", styles["value-mono"]),
            ],
            [
                Paragraph("<b>Chain tail:</b>", styles["label"]),
                Paragraph(tail or "—", styles["value-mono"]),
            ],
        ]
        ...
        if signature_info:
            ...
            signature_data = [
                [
                    ...
                    Paragraph(
                        str(signature_info.get("signer_name", "Unknown")),
                        styles["value"],
                    ),
                ],
                [
                    Paragraph("<b>Algorithm:</b>", styles["label"]),
                    Paragraph("Ed25519", styles["value"]),
                ],
                [
                    Paragraph("<b>Signature (hex):</b>", styles["label"]),
                    Paragraph(preview, styles["value-mono"]),
                ],
            ]
