        ...
        *,
        ...
        conn.execute(
            ...
            (
                ...
                int(methodology_disclosed),
                int(reliable_principles),
                int(principles_applied),
                int(opinion_not_speculative),
                validation_method,
                int(error_rate_known),
                error_rate_value,
                int(peer_reviewed),
                int(human_attorney_reviewed),
                human_reviewer_id,
                daubert_analysis,
                admissibility_opinion,
                admissibility_conditions,
                int(opposing_counsel_notified),
                court_ruling,
                hdr_id,
                generation_timestamp or now,
                hash_sha256,
                1,
                "draft",
                created_by,
        ...
        *,
        ...
        conn.execute(
            ...
            (
                ...
                int(citation_exists),
                int(proposition_accurate),
                int(quote_accurate),
                int(case_still_good_law),
                int(is_hallucination),
                hallucination_type,
                hallucination_severity,
                hallucination_notes,
                int(filed_with_court),
                int(corrective_action_taken),
        ...
        *,
        ...
        conn.execute(
            ...
            (
                ...
                cle_credits_earned,
                training_date,
                json.dumps(training_topics or []),
                json.dumps(ai_systems_covered or []),
                json.dumps(competence_areas or []),
                int(aba_rule_1_1_compliant),
                int(state_bar_compliant),
                renewal_due_date,
                certificate_number,
                issued_by,
                now,
